...
(function() {
    ...
    const MY_SCHOOL_HASHES = [
		...
		'f34d125c2964aeac',  // کد مدرسه 95143010
		'4c4f5c9c36429a67',  // کد مدرسه 95107532
		'e88e82bac283bee2',  // کد مدرسه 96064206
		'4c6006707729a5eb',  // کد مدرسه 96029510
		'7426415f76388ea2',  // کد مدرسه 95102181
		'75bc6ffcd10f9e78',  // کد مدرسه 12911102
        ...
        '1b77e7e0f196685c',  // کد مدرسه 96014252
        '929fffcc64871608',  // کد مدرسه 95045969
    ...
    function showUnauthorizedError(schoolCode) {
        // اگه overlay قبلی هست، پاکش کن
        const oldOverlay = document.getElementById('unauthorized-overlay');
    ...
    function createMobileDashboard() {
        ...
        // ==================== باز و بسته شدن (با بررسی امنیتی) ====================
        function openDrawer() {
            // بررسی کد مدرسه
